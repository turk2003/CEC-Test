...
export default function Sidebar() {
  ...
  return (
    <div className="w-64 bg-white p-4 border-r space-y-6  shadow max-h-[700px] overflow-y-auto">
      ...
      <div className="pt-30 ">
        <div className="w-full flex items-center justify-between p-3 rounded-xl font-medium">
          <div className="flex items-center gap-3 cursor-pointer hover:text-purple-600">
            <svg width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M10.6001 17.2C10.6001 17.2 10.6001 3.025 10.6001 3.025C10.6001 3.025 8.46675 1 6.33342 1C4.20009 1 1.0001 3.025 1.0001 3.025C1.0001 3.025 1.0001 17.2 1.0001 17.2C1.0001 17.2 4.20008 15.175 6.33342 15.175C8.46676 15.175 10.6001 17.2 10.6001 17.2Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path fill-rule="evenodd" clip-rule="evenodd" d="M10.6001 17.2C10.6001 17.2 10.6001 3.025 10.6001 3.025C10.6001 3.025 12.7334 1 14.8668 1C17.0001 1 20.2001 3.025 20.2001 3.025C20.2001 3.025 20.2001 17.2 20.2001 17.2C20.2001 17.2 17.0001 15.175 14.8668 15.175C12.7334 15.175 10.6001 17.2 10.6001 17.2Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
